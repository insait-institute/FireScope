...
def train(cfg: Cfg):
    ...
    # Datasets / loaders
    train_ds = CustomDataset(cfg.train_img_dir, cfg.train_rast_dir, '/work/wildfirerisk/vlm_cot_output_small_dataset.json')
    val_ds   = CustomDataset(cfg.val_img_dir, cfg.val_rast_dir, '/work/wildfirerisk/vlm_cot_output_small_dataset.json')
...
def build_cfg_from_args():
    ...
    p.add_argument('--out_dir', type=str, default='/work/wildfirerisk/trainings/small/alphaearth_oracle')
