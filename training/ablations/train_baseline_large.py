...
project_dir = f'/home/f{os.environ["USER"]}/FireScope'
...
def train(cfg: Cfg):
    ...
    # Datasets / loaders
    train_ds = CustomDataset(cfg.train_img_dir, cfg.train_rast_dir, climate_dir=cfg.climate_json, with_cheating=False)
    val_ds   = CustomDataset(cfg.val_img_dir, cfg.val_rast_dir, climate_dir=cfg.climate_json, with_cheating=False)
...
def build_cfg_from_args():
    ...
    p.add_argument('--out_dir', type=str, default='/work/wildfirerisk/trainings/big/unet_baseline')
